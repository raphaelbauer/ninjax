...
import static com.r10r.ninjax.core.Result.APPLICATION_JSON;
...
public class Json {
    ...
    public com.r10r.ninjax.core.Result.OutputStreamRenderer json(Object objectToRenderAsJson) {
            com.r10r.ninjax.core.Result.OutputStreamRenderer outputStreamRenderer = outputStream -> {
                try {
