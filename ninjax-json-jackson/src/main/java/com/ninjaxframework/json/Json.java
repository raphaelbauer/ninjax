package com.ninjaxframework.json;
...
import static com.ninjaxframework.core.Result.APPLICATION_JSON;
...
public class Json {
    ...
    public com.ninjaxframework.core.Result.OutputStreamRenderer json(Object objectToRenderAsJson) {
            com.ninjaxframework.core.Result.OutputStreamRenderer outputStreamRenderer = outputStream -> {
                try {
