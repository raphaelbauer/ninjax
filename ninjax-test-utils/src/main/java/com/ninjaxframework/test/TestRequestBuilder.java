...
public class TestRequestBuilder {
    ...
    private Optional<com.ninjaxframework.core.NinjaSession> ninjaSession = Optional.empty();
    private List<com.ninjaxframework.core.NinjaCookie> ninjaCookies = new ArrayList<>();
     ...
     * @return This builder
     */
    public TestRequestBuilder session(com.ninjaxframework.core.NinjaSession ninjaSession) {
     ...
     * @return This builder
     */
    public TestRequestBuilder cookie(com.ninjaxframework.core.NinjaCookie cookie) {
    ...
    public Request build() {
        ...
        return Request.builder()
                ...
                .parameters(new com.ninjaxframework.core.Request.Parameters(parameters))
