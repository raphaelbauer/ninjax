...
public class TestRequestBuilder {
    ...
    private Optional<com.r10r.ninjax.core.NinjaSession> ninjaSession = Optional.empty();
    private List<com.r10r.ninjax.core.NinjaCookie> ninjaCookies = new ArrayList<>();
     ...
     * @return This builder
     */
    public TestRequestBuilder session(com.r10r.ninjax.core.NinjaSession ninjaSession) {
     ...
     * @return This builder
     */
    public TestRequestBuilder cookie(com.r10r.ninjax.core.NinjaCookie cookie) {
    ...
    public Request build() {
        ...
        return Request.builder()
                ...
                .parameters(new com.r10r.ninjax.core.Request.Parameters(parameters))
