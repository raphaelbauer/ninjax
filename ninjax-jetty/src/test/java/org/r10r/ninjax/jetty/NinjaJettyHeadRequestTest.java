...
/**
 * Starts a real NinjaJetty server on an ephemeral port and talks raw HTTP to it, because a regular
 * HTTP client silently drops any body sent in a HEAD response.
 */
class NinjaJettyHeadRequestTest {
    ...
    static void startServer() throws Exception {
        ...
        Thread serverThread = new Thread(() -> new NinjaJetty(router, ninjaProperties));
