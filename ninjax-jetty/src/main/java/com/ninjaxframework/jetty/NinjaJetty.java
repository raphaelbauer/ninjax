package com.ninjaxframework.jetty;
...
import static com.ninjaxframework.jetty.NinjaSessionConverter.NINJA_SESSION_COOKIE_NAME;
import com.ninjaxframework.core.properties.NinjaProperties;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

// Imports from ninja-core
import com.ninjaxframework.core.Router;
import com.ninjaxframework.core.RouteFinder;
import com.ninjaxframework.core.Request;
import com.ninjaxframework.core.Result;
import com.ninjaxframework.core.NinjaCookie;
import com.ninjaxframework.core.NinjaSession;
import com.ninjaxframework.core.FileItem;
import com.ninjaxframework.core.FilterChain;
import com.ninjaxframework.core.PathParameterExtractor;
import com.ninjaxframework.core.Secure;
import com.ninjaxframework.core.HttpOnly;
...
public class NinjaJetty {
        ...
        public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, jakarta.servlet.FilterChain fc) throws IOException, ServletException {
            ...
            try {
                ...
                if (routingResult.isPresent()) {
                    ...
                    var parameters = new com.ninjaxframework.core.Request.Parameters(httpServletRequest.getParameterMap());
    ...
    public static class NinjaJettyHelper {
        ...
        public static com.ninjaxframework.core.NinjaCookie convertServletCookieToNinjaCookie(Cookie cookie) {

            return new com.ninjaxframework.core.NinjaCookie(
                    cookie.getName(),
                    cookie.getValue(),
        ...
        public static com.ninjaxframework.core.Request.Headers extractHeaders(HttpServletRequest httpServletRequest) {
            ...
            return new com.ninjaxframework.core.Request.Headers(headersMap);
