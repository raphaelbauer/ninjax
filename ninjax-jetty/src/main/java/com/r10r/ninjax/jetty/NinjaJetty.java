...
import static com.r10r.ninjax.jetty.NinjaSessionConverter.NINJA_SESSION_COOKIE_NAME;
...
import com.r10r.ninjax.core.RouteFinder;
import com.r10r.ninjax.core.Request;
import com.r10r.ninjax.core.Result;
import com.r10r.ninjax.core.NinjaCookie;
import com.r10r.ninjax.core.NinjaSession;
import com.r10r.ninjax.core.FileItem;
import com.r10r.ninjax.core.FilterChain;
import com.r10r.ninjax.core.PathParameterExtractor;
import com.r10r.ninjax.core.Secure;
import com.r10r.ninjax.core.HttpOnly;
...
public class NinjaJetty {
        ...
        public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, jakarta.servlet.FilterChain fc) throws IOException, ServletException {
            ...
            try {
                ...
                if (routingResult.isPresent()) {
                    ...
                    var parameters = new com.r10r.ninjax.core.Request.Parameters(httpServletRequest.getParameterMap());
    ...
    public static class NinjaJettyHelper {
        ...
        public static com.r10r.ninjax.core.NinjaCookie convertServletCookieToNinjaCookie(Cookie cookie) {

            return new com.r10r.ninjax.core.NinjaCookie(
                    cookie.getName(),
                    cookie.getValue(),
        ...
        public static com.r10r.ninjax.core.Request.Headers extractHeaders(HttpServletRequest httpServletRequest) {
            ...
            return new com.r10r.ninjax.core.Request.Headers(headersMap);
