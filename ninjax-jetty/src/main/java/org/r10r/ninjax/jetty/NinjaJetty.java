...
public class NinjaJetty {
    ...
    public static class NinjaJettyHelper {
        ...
        public static org.r10r.ninjax.core.NinjaCookie convertServletCookieToNinjaCookie(Cookie cookie) {
            ...
            return new org.r10r.ninjax.core.NinjaCookie(
                    cookie.getName(),
                    cookie.getValue(),
        ...
        public static org.r10r.ninjax.core.Request.Headers extractHeaders(HttpServletRequest httpServletRequest) {
            ...
            return new org.r10r.ninjax.core.Request.Headers(headersMap);
