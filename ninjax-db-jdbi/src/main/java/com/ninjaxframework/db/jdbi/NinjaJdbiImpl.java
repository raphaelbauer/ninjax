...
package com.ninjaxframework.db.jdbi;

import java.util.HashMap;
import java.util.Map;
import com.ninjaxframework.db.jdbc.NinjaDatasource;
import com.ninjaxframework.db.jdbc.NinjaDatasources;
...
public class NinjaJdbiImpl implements NinjaJdbi {
    ...
    public NinjaJdbiImpl(NinjaDatasources ninjaDatasources) {
        ...
        this.nameToDBIMap = Map.copyOf(map);
    }
